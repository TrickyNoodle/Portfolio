...
const Footer = () => {
    return (
        <div className='py-4'>
            <hr />
            <div className='w-3/4 mx-auto flex py-4 transition-all ease-in-out duration-300 not-md:flex-col [&>div]:my-2'>
                <div className='flex w-full flex-col gap-2'>
                    <p className='font-bold'>TrickyNoodle <Link to='https://github.com/TrickyNoodle' className='secondarycolor font-normal'>github.com/TrickyNoodle</Link></p>
